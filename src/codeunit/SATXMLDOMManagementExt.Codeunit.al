codeunit 50562 "SAT XML DOM Management Ext."
{
    ...
    procedure AddElementCData(var pXMLNode: XmlNode; pNodeName: Text; pNodeText: Text; pNameSpace: Text; var pCreatedNode: XmlNode): Boolean
    var
        lNewChildNode: XmlNode;
    begin
        IF pNodeText <> '' then
            lNewChildNode := XmlElement.Create(pNodeName, pNameSpace, XmlCData.Create(pNodeText)).AsXmlNode
        else
            lNewChildNode := XmlElement.Create(pNodeName, pNameSpace).AsXmlNode;
        if pXMLNode.AsXmlElement.Add(lNewChildNode) then begin
            pCreatedNode := lNewChildNode;
    ...
    procedure AddCFDIXmlElement(var pDocXmlNode: XmlNode; Name: Text; var pConceptXmlNode: XmlNode);
    var
        NameSpaceCFDI: Label 'http://www.sat.gob.mx/cfd/3', Locked = true;

    begin
        AddElement(pDocXmlNode, Name, '', NameSpaceCFDI, pConceptXmlNode)
    end;
    ...
    procedure AddPagos10XmlElement(var pDocXmlNode: XmlNode; Name: Text; var pConceptXmlNode: XmlNode);
    var
        NameSpaceCFDI: Label 'http://www.sat.gob.mx/Pagos', Locked = true;
    ...
    //Leyendas Fiscales >>
    procedure AddCFDIXmlElement(var pDocXmlNode: XmlNode; Name: Text; ValueNode: Text; var pConceptXmlNode: XmlNode);
    var
        NameSpaceCFDI2: Label 'http://www.sat.gob.mx/cfd/3', Locked = true;

    begin
        AddElement(pDocXmlNode, Name, ValueNode, NameSpaceCFDI2, pConceptXmlNode)
    end;

    procedure AddXmlElement(var pDocXmlNode: XmlNode; Name: Text; ValueNode: Text; var pConceptXmlNode: XmlNode; XmlNamespace: Text);
    var

    begin
        AddElement(pDocXmlNode, Name, ValueNode, XmlNamespace, pConceptXmlNode)
    end;
